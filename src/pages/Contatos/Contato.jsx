...
export async function listarContatos() {
  let retorno;
  await getDocs(collection(db, 'contatos')).then((querySnapshot) => {
...
export async function atualizarContato(id, contatoAtualizado) {
  const docRef = doc(db, 'contatos', id);
  await updateDoc(docRef, contatoAtualizado);
}
